...
class ArticleProvider (model.Provider):
    ...
    def create (self, record):
        ...
        with self.get_db_cursor() as cur:
            cur.execute("INSERT INTO article (uuid, status, article_id, timestamp_creation, timestamp_publish, title, article_type, site, lang, excerpt, article_category, url, image_url, body, body_markdown) VALUES(%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)", (record["uuid"], 1, record["article_id"], record["timestamp_creation"], record["timestamp_publish"], record["title"], record["article_type"], record["site"], record["lang"], record["excerpt"], record["article_category"], record["url"], record["image_url"], record["body"], record['body_markdown']))
    ...
    def update (self, record, request):
        ...
        with self.get_db_cursor() as cur:
            ...
            cur.execute("UPDATE article SET (status, article_id, timestamp_publish, title, article_type, site, lang, excerpt, article_category, url, image_url, body, body_markdown) = (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s) WHERE uuid=%s", (record.status, record.article_id, record.timestamp_publish, record.title, record.article_type, record.site, record.lang, record.excerpt, record.article_category, record.url, record.image_url, record.body, record.body_markdown, record.uuid,))
            return True
